<template>
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 990">
		...
		<g :mask="'url(#' + maskId + ')'">
			...
			<component :is="values.body.Back" :skin="values.skinTone" :color="values.clothingColor" :braStraps="values.clothing.Back == null" />
